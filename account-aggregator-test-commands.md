# Account Aggregator API Test Commands

## Upload Account Aggregator Data (JSON in Request Body)

```bash
# First, login as a user to get a session cookie
...
# Then upload account aggregator data using the session cookie
...
```bash
# Create a JSON file with account aggregator data
